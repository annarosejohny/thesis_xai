...
from utils import freeze_modules, unfreeze_modules
...
class MyArcFace(nn.Module):
    ...
    def __init__(self,
                 num_classes,
                 dataset_base=os.path.join("/home/ash/Desktop/thesis_anna/GestaltMatcher-Arc/saved_models", "glint360k_r100.onnx"),
                 device="cuda",
                 freeze=False):
